    ...
    <div class="mx-auto bg-white rounded-lg p-3">
      ...
      >
        ...
        <TextInput
          ...
          v-model:input="addressInfo.contactName"
          inputType="input"
        ...
        <TextInput
          class="w-full mt-2"
          placeholder="Address"
          v-model:input="addressInfo.address"
          inputType="input"
        ...
        <TextInput
          ...
          v-model:input="addressInfo.zipCode"
          inputType="input"
        ...
        <TextInput
          class="w-full"
          placeholder="City"
          v-model:input="addressInfo.city"
          inputType="input"
        ...
        <TextInput
          class="w-full"
          placeholder="Country"
          v-model:input="addressInfo.country"
          inputType="input"
          :error="error && error.type == 'country' ? error.message : ''"
        />
        <div
          v-if="error && error.type === 'api'"
  ...
  const submit = async () => {
    ...
    if (isUpdate) {
      response = await useFetch(
        `/api/update-address/${currentAddress.value.id}`,
        {
          method: 'PATCH',
          body,
        }
