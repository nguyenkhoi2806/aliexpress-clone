<template>
  ...
  >
    <div
      ...
      class="h-[500px] flex items-center justify-center flex-col"
    >
      <div class="pt-20"></div>
      <img
        class="mx-auto"
      ...
      <div
        v-if="!user"
        class="flex text-center w-[300px]"
      >
        <NuxtLink
          to="/auth"
          class="bg-[#FD374F] w-full text-white text-[18px] font-semibold p-1.5 rounded-full mt-4"
        >
          Sign in
        </NuxtLink>
      </div>
    ...
    >
      ...
      <div class="md:w-[35%]">
        ...
        >
          ...
          <button
            @click="goToCheckout"
            class="flex items-center justify-center bg-[#FD374F] w-full text-white text-[18px] font-semibold p-1.5 rounded-full mt-4"
          >
            Checkout
          </button>
        </div>
